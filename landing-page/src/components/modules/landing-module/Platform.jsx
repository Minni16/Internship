export default function Platforms() {
    const platformList = [
        { logo: "/src/assets/windows.png", caption: "Windows" },
        { logo: "/src/assets/browser.png", caption: "Browser" },
        { logo: "/src/assets/android.png", caption: "Android" },
        { logo: "/src/assets/apple.png", caption: "Apple" }
    ];
    return (
