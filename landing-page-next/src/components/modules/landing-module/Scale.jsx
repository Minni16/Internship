export default function Scale() {
    const scaleList = [
        { logo: "/3.png", heading: "API-First Architecture", caption: "RESTful APIs and comprehensive SDKs for all major platforms" },
        { logo: "/5.png", heading: "Platform Compatibility", caption: "Works with web, mobile, desktop, and hybrid applications" },
        { logo: "/1.png", heading: "Security & Compliance", caption: "End to End encryption compatible with enterprise standards" },
        { logo: "/4.png", heading: "Scalability & Performance", caption: "Real time chat with sub-100ms response times" }
    ];
    return (
