export default function Features() {
    const featureList = [
        { logo: "/1.png", heading: "End-to-End Encryption", caption: "Military-grade security ensures your conversations stay private" },
        { logo: "/2.png", heading: "White-Label Solution", caption: "Your brand, your domain, your complete control" },
        { logo: "/3.png", heading: "API-First Integration", caption: "Seamlessly embed into any software with our developer-friendly APIs" },
        { logo: "/4.png", heading: "Enterprise Scalability", caption: "From small teams to global organizations, Xylochat grows with you" }
    ];
    return (
